...
def generate_worlds_gtv2_live_task(
    *,
    ...
    team_implied_points_reconcile_alpha: float = _TEAM_IMPLIED_POINTS_RECONCILE_ALPHA,
    team_implied_points_reconcile_deadband_points: float = _TEAM_IMPLIED_POINTS_RECONCILE_DEADBAND_POINTS,
