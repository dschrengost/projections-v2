...
def test_build_minutes_live_uses_report_time_semantics_for_bronze_injuries(
    tmp_path: Path, monkeypatch
) -> None:
    run_id = "pytest_bronze_injuries_report_ts"
    ...
    # Report was published at tip, but scraped later. The live builder should
    # still treat it as pre-tip via the report URL timestamp.
    bronze_injuries = pd.DataFrame(
        {
            "game_id": [22500471, 22500471],
            "player_id": [101, 101],
            "team_id": [1610612751, 1610612751],
            "player_name": ["Porter Jr., Michael", "Porter Jr., Michael"],
            "status": ["Q", "OUT"],
            "restriction_flag": [False, False],
            "ramp_flag": [False, False],
            "games_since_return": [0, 0],
            "days_since_return": [0, 0],
            "as_of_ts": ["2026-01-01T23:30:00Z", "2026-01-02T00:30:00Z"],
            "ingested_ts": ["2026-01-01T23:30:00Z", "2026-01-02T00:45:00Z"],
            "source": [
                "https://ak-static.cms.nba.com/referee/injury/Injury-Report_2026-01-01_06_00PM.pdf",
                "https://ak-static.cms.nba.com/referee/injury/Injury-Report_2026-01-01_07_00PM.pdf",
            ],
            "source_row_id": ["x1", "x2"],
            "status_raw": ["Questionable", "Out"],
            "notes_raw": ["", ""],
