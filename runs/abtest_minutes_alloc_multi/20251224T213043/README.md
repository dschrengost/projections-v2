...
Generated: 2025-12-24T21:30:51.734405
...
|--------|---|---|---|---|---|---|--------|
| MAE (mean) | 5.43 | 5.29 | 5.12 | 5.07 | 5.10 | N/A | D |
| RMSE (mean) | 7.44 | 7.89 | 7.81 | 7.60 | 7.66 | N/A | A |
| Top-5 sum | 148.7 | 146.1 | 162.4 | 162.0 | 161.2 | 0.0 | C |
| Ordering 10-30 | 0.717 | 0.677 | 0.702 | 0.693 | 0.694 | N/A | – |
| Max minutes | 35.3 | 31.7 | 38.5 | 37.8 | 37.9 | 0.0 | – |
| Gini | 0.431 | 0.177 | 0.284 | 0.277 | 0.271 | 0.000 | – |
| Roster size | 16.5 | 11.0 | 11.0 | 11.0 | 11.0 | 0.0 | – |
...
|--------|--------|--------|--------|--------|--------|
| % slates wins MAE | 41.7% | 66.7% | 66.7% | 66.7% | N/A% |
| % slates wins top5 | 58.3% | 100.0% | 100.0% | 100.0% | N/A% |
| % slates wins both | 33.3% | 66.7% | 66.7% | 66.7% | N/A% |
| MAE delta mean±std | +0.14 ± 0.43 | -0.16 ± 0.46 | -0.21 ± 0.35 | -0.19 ± 0.37 | N/A ± N/A |

## Per-Bucket Analysis (Clean Slates)

| Bucket | MAE (A) | MAE (B) | MAE (C) | MAE (D) | MAE (E) | MAE (M) | Winner |
|--------|---------|---------|---------|---------|---------|---------|--------|
| 0-10 min | 4.39 | 4.59 | 3.53 | 3.53 | 3.66 | N/A | C |
| 10-20 min | 6.35 | 5.32 | 7.25 | 7.03 | 6.92 | N/A | B |
| 20-30 min | 6.98 | 6.38 | 7.44 | 7.67 | 7.54 | N/A | B |
| 30+ min | 5.89 | 5.82 | 5.17 | 4.83 | 4.88 | N/A | D |
...
| Bench crush (mean) | 9.0 | 14.6 | 9.6 | 10.0 | 10.2 | 0.0 |
| Bench crush (p90) | 10.2 | 14.9 | 10.9 | 11.1 | 11.1 | 0.0 |
