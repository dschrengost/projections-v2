...
Generated: 2025-12-25T18:34:58.027758
...
|--------|---|---|---|---|---|---|--------|
| MAE (mean) | 4.87 | 4.17 | 4.81 | 4.45 | 4.57 | N/A | B |
| RMSE (mean) | 7.38 | 6.41 | 7.57 | 6.90 | 7.04 | N/A | B |
| Top-5 sum | 147.3 | 153.6 | 155.2 | 158.4 | 159.4 | N/A | F |
| Ordering 10-30 | 0.684 | 0.741 | 0.688 | 0.724 | 0.708 | N/A | – |
| Max minutes | 34.5 | 34.0 | 36.3 | 37.3 | 37.5 | N/A | – |
| Gini | 0.324 | 0.211 | 0.226 | 0.262 | 0.269 | N/A | – |
...
| MAE delta mean±std | +0.70 ± 0.19 | +0.64 ± 0.23 | +0.28 ± 0.24 | +0.40 ± 0.23 | N/A ± N/A |

## Per-Bucket Analysis (Clean Slates)

| Bucket | MAE (A) | MAE (B) | MAE (C) | MAE (D) | MAE (E) | MAE (M) | Winner |
|--------|---------|---------|---------|---------|---------|---------|--------|
| 0-10 min | 2.91 | 3.12 | 2.71 | 2.52 | 2.53 | N/A | D |
| 10-20 min | 6.52 | 4.78 | 7.37 | 6.68 | 7.11 | N/A | B |
| 20-30 min | 7.03 | 6.01 | 7.15 | 6.61 | 6.85 | N/A | B |
| 30+ min | 6.58 | 4.48 | 5.96 | 5.48 | 5.56 | N/A | F |
...
| Bench crush (mean) | 10.5 | 13.0 | 10.8 | 10.4 | 9.4 | N/A |
| Bench crush (p90) | 13.3 | 14.4 | 14.8 | 13.9 | 12.6 | N/A |
