...
Generated: 2025-12-25T18:43:44.876653
...
|--------|---|---|---|---|---|---|--------|
| MAE (mean) | 4.87 | 4.66 | 4.81 | 4.45 | 4.57 | N/A | D |
| RMSE (mean) | 7.38 | 7.06 | 7.57 | 6.90 | 7.04 | N/A | D |
| Top-5 sum | 147.3 | 169.1 | 155.2 | 158.4 | 159.4 | N/A | F |
| Ordering 10-30 | 0.684 | 0.702 | 0.688 | 0.724 | 0.708 | N/A | – |
| Max minutes | 34.5 | 39.3 | 36.3 | 37.3 | 37.5 | N/A | – |
| Gini | 0.324 | 0.290 | 0.226 | 0.262 | 0.269 | N/A | – |
...
|--------|--------|--------|--------|--------|--------|
| % slates wins MAE | 42.9% | 42.9% | 85.7% | 42.9% | N/A% |
| % slates wins top5 | 0.0% | 0.0% | 28.6% | 28.6% | N/A% |
| % slates wins both | 0.0% | 0.0% | 28.6% | 28.6% | N/A% |
| MAE delta mean±std | +0.21 ± 0.46 | +0.15 ± 0.37 | -0.20 ± 0.28 | -0.09 ± 0.31 | N/A ± N/A |

## Per-Bucket Analysis (Clean Slates)

| Bucket | MAE (A) | MAE (B) | MAE (C) | MAE (D) | MAE (E) | MAE (M) | Winner |
|--------|---------|---------|---------|---------|---------|---------|--------|
| 0-10 min | 2.91 | 2.74 | 2.71 | 2.52 | 2.53 | N/A | F |
| 10-20 min | 6.52 | 6.23 | 7.37 | 6.68 | 7.11 | N/A | B |
| 20-30 min | 7.03 | 8.25 | 7.15 | 6.61 | 6.85 | N/A | D |
| 30+ min | 6.58 | 4.76 | 5.96 | 5.48 | 5.56 | N/A | B |

## Pathology Checks (Clean Slates)

| Metric | A | B | C | D | E | M |
|--------|---|---|---|---|---|---|
| % slates with top5 < 150 | 30.0% | 0.0% | 30.0% | 30.0% | 30.0% | N/A% |
| % slates with max < 30 | 30.0% | 0.0% | 0.0% | 0.0% | 0.0% | N/A% |
| Bench crush (mean) | 10.5 | 9.6 | 10.8 | 10.4 | 9.4 | N/A |
| Bench crush (p90) | 13.3 | 11.6 | 14.8 | 13.9 | 12.6 | N/A |

## Recommendation

**Keep RotAlloc**: It outperforms on accuracy metrics.
