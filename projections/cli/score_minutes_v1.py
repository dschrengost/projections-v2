        ...
        try:
            ...
            alloc_summary = {
                ...
                "config": {
                    ...
                    "dynamic_k_bounds_enabled": occupancy_cfg.dynamic_k_bounds_enabled,
                    "dynamic_k_max_cap": occupancy_cfg.dynamic_k_max_cap,
                    "dynamic_k_min_floor": occupancy_cfg.dynamic_k_min_floor,
                    "dynamic_k_window": occupancy_cfg.dynamic_k_window,
                    "dynamic_depth_prob_floor": occupancy_cfg.dynamic_depth_prob_floor,
                    "dynamic_depth_minutes_floor": occupancy_cfg.dynamic_depth_minutes_floor,
                    "dynamic_bench_share_midpoint": occupancy_cfg.dynamic_bench_share_midpoint,
                    "dynamic_bench_share_scale": occupancy_cfg.dynamic_bench_share_scale,
                    "dnp_suppression_enabled": occupancy_cfg.dnp_suppression_enabled,
                    "dnp_rate_threshold": occupancy_cfg.dnp_rate_threshold,
                ...
                "diagnostics": {
                    ...
                    "k_min_eff_p50": float(occ_diag["k_min_eff"].quantile(0.5)) if not occ_diag.empty else float("nan"),
                    "k_max_eff_p50": float(occ_diag["k_max_eff"].quantile(0.5)) if not occ_diag.empty else float("nan"),
