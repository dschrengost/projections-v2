...
from projections.api.flashback_api import router as flashback_router
...
def create_app(
    *,
    ...
    def get_version() -> JSONResponse:
        ...
        return JSONResponse({
            "git_sha": _stamp.git_sha,
            "git_branch": _stamp.git_branch,
            "git_dirty": _stamp.git_dirty,
            "server_started_at": _stamp.timestamp,
            "python_version": _stamp.python_version,
            "pid": _stamp.pid,
    ...
    app.include_router(flashback_router, prefix="/api/flashback", tags=["flashback"])
